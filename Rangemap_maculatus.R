...
polymacul<-readShapePoly("/Users/cooper/GitHub/PipiloRangeMaps/Pipilo_maculatus_22729113.shp")
...
dev.new(5,4)
mexico_states <- readShapePoly("/Users/cooper/GitHub/PipiloRangeMaps/mexstates.shp") 
canada_provs<-readShapePoly("/Users/cooper/GitHub/PipiloRangeMaps/PROVINCE.shp")
